...
from practice.common.variables import ERROR, RESPONSE_205, USER, ACCOUNT_NAME, PUBLIC_KEY, RESPONSE_200, RESPONSE, \
    RESPONSE_400, DATA, RESPONSE_511, PUBLIC_KEY_REQUEST, ACTION, LIST_INFO, RESPONSE_202, USERS_REQUEST, \
    REMOVE_CONTACT, ADD_CONTACT, GET_CONTACTS, EXIT, DESTINATION, SENDER, PRESENCE, TIME, MAX_CONNECTIONS
